...
namespace Bau.Libraries.LibDocWriter.ViewModel.Solutions
{
	...
	{ 
		...
		{
			_file = file;
			NewName = System.IO.Path.GetFileNameWithoutExtension(file.IDFileName);
		}
		...
		private bool ValidateData()
		{
			bool validate = false;
				...
				if (NewName.IsEmpty())
					DocWriterViewModel.Instance.ControllerWindow.ShowMessage("Introduzca el nuevo nombre del archivo");
				else
					validate = true;
