...
namespace Bau.Plugins.DataBaseStudio.Views.Reports.UC
{
	...
	/// </summary>
	public partial class ctlListExecutionParameters : UserControl
	{
		public ctlListExecutionParameters()
		{
			InitializeComponent();
		}
		...
		/// </summary>
		public void InitControl(ReportExecutionListViewModel dataContext)
		{
